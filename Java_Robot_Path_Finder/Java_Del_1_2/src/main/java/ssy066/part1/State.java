...
public final class State {
	...
	public State newState(String var, Object value) {
        if(!state.containsKey(var)){throw new java.util.NoSuchElementException("The variable "+var+" is not part of the state");}
        Map<String, Object> stateMap = new HashMap<>();
        stateMap.putAll(state);
        stateMap.put(var, value);
        State stateNew = new State(stateMap);
        return stateNew ;
        }
	...
	public State newState(Map<String, Object> updVars) {
        if(!state.keySet().containsAll(updVars.keySet())){throw new NoSuchElementException("The variable "+updVars+" is not part of the state");}
        Map<String, Object> stateMap = new HashMap<String, Object>();
        stateMap.putAll(state);
        stateMap.putAll(updVars);
        State stateNew = new State(stateMap);
        return stateNew ;
