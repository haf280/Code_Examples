...
public class Test4_Optimization extends TestCase {
    ...
    public void test_find_shortest_path() {
        ...
        System.out.println(result.getCostToGoal());

        assert (result.getPath().equals(shortestPath));
    }

    public void test_find_lowestCost_path_WithLoop() {
        Graph g = searchGraph_with_loops();
        SearchAGraph search = new SearchAGraph();
...
//        State state = new State(stateMap);
        ...
        SearchResult result = search.findLowestCostPath(g, goal);
        ...
        System.out.println("found: " + result.getPath());
        System.out.println("should be: " + shortestPath);
        System.out.println("cost: " + result.getCostToGoal());
     ...
     * @return the graph
     */
    public void test_find_shortest_path_withLoop() {
        Graph g = searchGraph_with_loops();
        SearchAGraph search = new SearchAGraph();
