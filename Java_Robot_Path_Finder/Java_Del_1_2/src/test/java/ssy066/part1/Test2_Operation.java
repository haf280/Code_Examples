 ...
 *
 * When you have both predicates and actions, you finally can implement the operation. An operation has a guard
...
public class Test2_Operation extends TestCase {
	...
	public void test2_5_writingPredicates() {
		Predicate p2 = new EQ(v1, 0);
		Predicate p3 = new EQ(v2, true);
		Predicate p4 = new EQ(v3, "Running");
		Predicate p1 = new OR((new AND(p2,new NOT(p3))), (new OR(p4,p3)));
